...
class DBWNode(object):
    def __init__(self):
        ...
        fuel_capacity = rospy.get_param('~fuel_capacity', 13.5) # litres
        brake_deadband = rospy.get_param('~brake_deadband', .1)
        decel_limit = rospy.get_param('~decel_limit', -5) # m/s^2
        accel_limit = rospy.get_param('~accel_limit', 1.)
        wheel_radius = rospy.get_param('~wheel_radius', 0.2413) # meters
        wheel_base = rospy.get_param('~wheel_base', 2.8498) # meters
